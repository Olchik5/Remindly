...
public class HelperBase {
    ...
    public void moveUp(By locator) {
        ...
        Dimension size = driver.manage().window().getSize();
        //get activity points
        int downPiont = (int) (size.height * 0.6);
        int upPiont = (int) (size.height * 0.5);
        ...
        action.longPress(PointOption.point(middleX, downPiont))
                .moveTo(PointOption.point(middleX,upPiont))
                .release()
                .perform();
    ...
    public void moveDown(By locator) {
        ...
        Dimension size = driver.manage().window().getSize();
        //get activity points
        int downPiont = (int) (size.height * 0.5);
        int upPiont = (int) (size.height * 0.6);
        //get elements's point
        WebElement element = driver.findElement(locator);
        int leftX = element.getLocation().getX();
        int rightX = leftX + element.getSize().getWidth();
